...
public record CreateCommunityCommand(UserId ownerId, ProfileId ownerProfileId, String name, String description, String imageUrl) {
    public CreateCommunityCommand {
        if (ownerId == null) throw new IllegalArgumentException("ownerId required");
        if (ownerProfileId == null) throw new IllegalArgumentException("ownerProfileId required");
